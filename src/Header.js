      ...
      return(
        <div>
          <Navbar light expand="md">
            <NavbarBrand href="/"><h3 className="header-font"><img width="5%" height="auto" src={"https://ethorse.com/images/ethorse-logo.png"} alt="ETHorse icon"/>&nbsp;ETHORSE</h3></NavbarBrand>
