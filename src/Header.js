            ...
            <Modal isOpen={this.state.modal} toggle={this.toggle} size="lg" style={{
                ...
                <ModalBody>
                    ...
                    <ul class="help-text">
                        ...
                        <li>If the coin start or end prices are not received on Blockchain from Oraclize in 15 minutes, the contract can only refunds the bettor, no winners/losers will be decided</li>
